...
$query = 'SELECT c.customerID, emailAddress, firstName, lastName, line1, city, state, zipCode, phone FROM customers c INNER JOIN addresses a ON c.customerID = a.customerID GROUP BY customerID, emailAddress, firstName, lastName, line1, city, state, zipCode, phone';// PUT YOUR SQL QUERY HERE
